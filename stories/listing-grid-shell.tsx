...
//     mortgageType: mortgage.mortgageType === 1 ? "First" : mortgage.mortgageType === 2 ? "Second" : "Other",
...
//     const [interestRateMin, interestRateMax] = sampleListings.reduce<[number, number]>(
//       (acc, listing) => {
//         return [Math.min(acc[0], listing.interestRate), Math.max(acc[1], listing.interestRate)]
//       },
//       [15, 0]
//     )

//     const [loanAmountMin, loanAmountMax] = sampleListings.reduce<[number, number]>(
//       (acc, listing) => {
//         return [Math.min(acc[0], listing.loanAmount), Math.max(acc[1], listing.loanAmount)]
//       },
//       [1000000, 0]
//     )
...
//       (acc, listing) => {
//         return [Math.min(acc[0], listing.marketValue), Math.max(acc[1], listing.marketValue)]
//       },
//       [1000000, 0]
//     )
...
//       <div className="wide1xl:w-[70%] wide2xl:w-[65%] w-[60%] space-y-4">
//         <FilterBar filters={filters} onFiltersChange={handleFiltersChange} />
//         <PropertyCardList
//           filteredListings={filteredListings}
//           onFiltersChangeAction={handleFiltersChange}
...
//         />
//       </div>
//       <div className="wide1xl:w-[30%] wide2xl:w-[35%] w-[40%] py-4">
