...
const meta: Meta<typeof Tour> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: "Interactive tour component with step-by-step guidance and tooltips. Creates an overlay with highlighted target elements and popup cards with navigation controls.",
      },
    },
  },
  argTypes: {
    steps: {
      description: "Array of tour steps with target selectors, titles, descriptions, and placement options",
    },
    open: {
    ...
    placement: {
      ...
      description: "Default placement for tour tooltips relative to target elements",
    },
  },
  decorators: [
    (Story) => (
...
const sampleSteps = [
  {
    ...
    description: "Let's take a quick tour to help you get started with all the amazing features we have to offer.",
    placement: "bottom" as const,
  },
  {
    target: "#dashboard-area",
    title: "Your Dashboard",
    description: "This is your personalized dashboard where you can see all your important information at a glance.",
  ...
  },
  {
    ...
    description: "Manage your account settings, preferences, and personal information here.",
...
export const Default: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: "Default tour showing basic configuration with multiple steps and different tooltip positions.",
      },
    },
  },
};
    ...
    steps: [
      {
        ...
        description: "Welcome! This quick tour will help you understand the basics of using our platform effectively.",
        placement: "bottom" as const,
      },
      {
        target: "#create-first",
        title: "Create Your First Project",
        description: "Click here to create your first project. Projects help you organize your work and collaborate with others.",
        placement: "bottom" as const,
      },
      {
        target: "#invite-team",
        title: "Invite Team Members",
        description: "Collaboration is key! Invite your team members to work together on projects.",
        placement: "right" as const,
      },
      {
        target: "#explore",
        title: "Explore Features",
        description: "Take some time to explore all the features available to you. There's a lot to discover!",
        placement: "left" as const,
      },
    ],
    open: true,
    ...
    steps: [
      {
        ...
        description: "Track performance, user engagement, and key metrics with our comprehensive analytics dashboard.",
        placement: "bottom" as const,
      },
      {
        target: "#automation",
        title: "Workflow Automation",
        description: "Automate repetitive tasks and create powerful workflows to save time and reduce errors.",
    ...
    steps: [
      {
        ...
        description: "This tour features custom styling to match your brand and design requirements.",
        placement: "bottom" as const,
      },
    ],
    open: true,
    ...
    steps: [
      {
        ...
        description: "Learn about our product's key features and benefits that will help you achieve your goals.",
        placement: "bottom" as const,
      },
      {
        target: "#analytics-feature",
        title: "Smart Analytics",
        description: "Get insights and recommendations based on your data with our AI-powered analytics engine.",
        placement: "right" as const,
      },
      {
        target: "#collaboration-feature",
        title: "Real-time Collaboration",
        description: "Work together with your team in real-time, no matter where you are located.",
        placement: "left" as const,
      },
      {
