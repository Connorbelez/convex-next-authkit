...
const meta: Meta<typeof ContentCarousel> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: "Flexible content carousel component for displaying images, cards, or any custom content with navigation controls.",
      },
    },
  },
  argTypes: {
    ...
    items: [
      {
        ...
        content: (
          <div className="bg-gradient-to-r from-blue-500 to-purple-600 text-white p-8 rounded-lg text-center">
            ...
            <p className="opacity-90">Amazing feature with gradient background</p>
          </div>
        ),
      },
      {
...
export const TestimonialCarousel: Story = {
        ...
        content: (
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg text-center">
            <div className="w-16 h-16 bg-green-100 rounded-full mx-auto mb-4 flex items-center justify-center">
              <span className="text-green-600 font-bold text-xl">SM</span>
            </div>
            <p className="text-gray-600 dark:text-gray-400 italic mb-4">
              "Outstanding quality and exceptional customer service. A game changer!"
            </p>
        ...
        content: (
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg text-center">
            <div className="w-16 h-16 bg-purple-100 rounded-full mx-auto mb-4 flex items-center justify-center">
              <span className="text-purple-600 font-bold text-xl">RJ</span>
            </div>
            <p className="text-gray-600 dark:text-gray-400 italic mb-4">
              "Innovative solution that solved our biggest challenges. Absolutely love it!"
            </p>
            <p className="font-semibold">Robert Johnson</p>
            <p className="text-sm text-gray-500">Manager, Startup Inc</p>
          </div>
        ),
      },
    ],
  ...
  parameters: {
    docs: {
      description: {
        story: "Testimonial carousel with customer reviews and profile information.",
      },
    },
  },
};
