...
const meta: Meta<typeof RangeSliderWithHistogram> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: "An interactive range slider with histogram visualization for budget ranges or data distribution.",
      },
    },
  },
  argTypes: {
...
export const Default: Story = {
  args: {
    ...
    step: 50000,
    histogramData: [
      500, 800, 1200, 1800, 2400, 3000, 2800, 2200, 1800, 1400,
      1000, 800, 600, 400, 300, 200, 150, 100, 50, 25
    ],
...
export const SmallBudget: Story = {
  args: {
    ...
    step: 5000,
    histogramData: [
      450, 680, 1200, 980, 750, 520, 380, 290, 180, 120,
      80, 60, 40, 60, 40, 60, 5, 3, 2, 1
    ],
...
export const WithDefaultValues: Story = {
  args: {
    ...
    histogramData: [
      300, 600, 900, 1400, 1800, 2200, 2600, 2400, 2000, 1600,
      1200, 900, 700, 500, 400, 300, 200, 150, 100, 50
    ],
    formatValue: (value: number) => `£${(value / 1000).toFixed(0)}k`,
  },
};
...
export const HighBuffer: Story = {
  args: {
    ...
    histogramData: [
      150, 300, 600, 900, 1200, 1500, 1200, 900, 600, 450,
      300, 225, 150, 100, 75, 50, 35, 25, 15, 10
    ],
    formatValue: (value: number) => `$${value.toLocaleString()}`,
  },
};
...
export const Interactive: Story = {
      ...
      <div className="space-y-4 p-4">
        ...
        <div className="bg-gray-100 p-4 rounded-lg">
          ...
          <p className="text-sm font-semibold">
            Range Size: {args.formatValue ? args.formatValue(range[1] - range[0]) : range[1] - range[0]}
          </p>
        </div>
      </div>
    );
  ...
  args: {
    ...
    histogramData: [
      200, 400, 800, 1200, 1600, 2000, 2400, 2800, 3200, 2800,
      2400, 2000, 1600, 1200, 800, 600, 400, 300, 200, 100
    ],
    formatValue: (value: number) => `$${(value / 1000).toFixed(0)}k`,
  },
};
...
export const Compact: Story = {
  args: {
    ...
    step: 1000,
    histogramData: [
      120, 240, 480, 720, 960, 1200, 1440, 1680, 1920, 1680,
      1440, 1200, 960, 720, 480, 360, 240, 180, 120, 60
    ],
    formatValue: (value: number) => `$${value.toLocaleString()}`,
    className: "p-4",
    minLabel: "Min",
