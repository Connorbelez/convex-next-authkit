...
import { DEFAULT_FILTERS, type FilterState } from "@/components/types/listing-filters";
...
const meta: Meta<typeof FilterBar> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: "Interactive filter bar component for mortgage listings with search, filters (LTV, interest rate, mortgage types, property types), and maturity date filtering.",
      },
    },
  },
  argTypes: {
    filters: {
      description: "Current filter state including ranges, types, and search query",
    },
    onFiltersChange: {
...
export const WithActiveFilters: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: "Filter bar with some pre-selected filters showing active state.",
      },
    },
  },
};
...
export const FullyFiltered: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: "Filter bar with all available filters applied showing full state.",
      },
    },
  },
};
