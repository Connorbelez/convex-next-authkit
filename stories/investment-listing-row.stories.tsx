...
import { InvestmentListingRow, type InvestmentListingProps } from "@/components/investment-listing-row";
...
const meta: Meta<typeof InvestmentListingRow> = {
    ...
    parameters: {
        ...
        docs: {
            description: {
                component: "Horizontal KPI-first row highlighting Principal, LTV, and Interest with a small thumbnail.",
            },
        },
    },
    argTypes: {
        ...
        interestAprPercent: { control: { type: "range", min: 0, max: 20, step: 0.1 } },
    },
};
...
const sampleThumb = "https://images.unsplash.com/photo-1560448204-e02f11c3d0e2?w=300&h=300&fit=crop";
