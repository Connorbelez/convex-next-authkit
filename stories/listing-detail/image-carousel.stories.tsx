...
const meta: Meta<typeof ImageCarousel> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: "An interactive image carousel with navigation arrows, thumbnail navigation, and keyboard support. Perfect for property listings with multiple photos.",
      },
    },
  },
  decorators: [
...
export const Default: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: "Default image carousel with multiple property photos, navigation arrows, and thumbnail strip.",
      },
    },
  },
};
...
export const MultipleImages: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: "Carousel with many images showing full navigation functionality with counter and thumbnails.",
      },
    },
  },
};
...
export const SingleImage: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: "Single image property - navigation arrows and thumbnails are hidden when only one image is available.",
      },
    },
  },
};
...
export const NoImages: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: "Empty state when no images are available - shows placeholder with icon and message.",
      },
    },
  },
};
...
export const WithKeyboardNavigation: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: "Use arrow keys (← →) to navigate through images. Fully accessible with keyboard support.",
      },
    },
  },
};
...
export const MinimalImages: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: "Property with just two images - still shows full navigation functionality.",
      },
    },
  },
};
...
export const LargePropertyTitle: Story = {
  args: {
    images: sampleImages,
    propertyTitle: "Extraordinary Luxury Mediterranean Villa with Panoramic Ocean Views and Private Beach Access in Malibu Colony",
  },
  parameters: {
    docs: {
      description: {
        story: "Testing accessibility with very long property titles for proper screen reader announcements.",
      },
    },
  },
};