...
const meta: Meta<typeof PropertyInfo> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: "Comprehensive property information display showing address, property type, key features, and investment brief. Perfect for real estate listings.",
      },
    },
  },
  decorators: [
...
export const Default: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: "Complete property information including address, location details, and investment brief.",
      },
    },
  },
};
...
export const LuxuryProperty: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: "High-end luxury property with premium location and comprehensive investment details.",
      },
    },
  },
};
...
export const InvestmentProperty: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: "Investment-focused property with detailed investor brief highlighting returns and market potential.",
      },
    },
  },
};
...
export const MinimalInfo: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: "Property with minimal information - no investment brief provided.",
      },
    },
  },
};
...
export const DifferentPropertyTypes: Story = {
  render: () => {
    ...
    return (
      <div className="space-y-6">
        <div>
          <h3 className="text-sm font-medium mb-2">Condominium</h3>
          <PropertyInfo
            title={condo.title}
        ...
        <div>
          <h3 className="text-sm font-medium mb-2">Single Family Home</h3>
          <PropertyInfo
            title={house.title}
        ...
        <div>
          <h3 className="text-sm font-medium mb-2">Luxury Estate</h3>
          <PropertyInfo
            title={mansion.title}
  ...
  parameters: {
    docs: {
      description: {
        story: "Various property types showing how the component adapts to different real estate categories.",
      },
    },
  },
};
...
export const WithLongInvestorBrief: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: "Property with comprehensive investor brief showing detailed investment analysis and market insights.",
      },
    },
  },
};
...
export const NewListing: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: "Recently listed property with current timestamps showing fresh market entry.",
      },
    },
  },
};
...
export const EstablishedProperty: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: "Established property that has been on the market for an extended period.",
      },
    },
  },
};