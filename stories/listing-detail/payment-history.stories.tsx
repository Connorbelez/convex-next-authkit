...
const meta: Meta<typeof PaymentHistory> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: "Interactive payment history table showing payment status, amounts, dates, and types. Perfect for tracking loan payments and investment performance.",
      },
    },
  },
  decorators: [
...
export const Default: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: "Standard payment history showing mix of paid, pending, and late payments over 12 months.",
      },
    },
  },
};
...
export const MixedStatuses: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: "Extended payment history showing various payment statuses including on-time, late, and pending payments.",
      },
    },
  },
};
...
export const AllPaid: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: "Perfect payment history with all payments made on time - shows ideal borrower behavior.",
      },
    },
  },
};
...
export const WithLatePayments: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: "Payment history with late payments - shows realistic scenario with occasional payment delays.",
      },
    },
  },
};
...
export const EmptyHistory: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: "Empty payment history for new loans or properties with no payment history yet.",
      },
    },
  },
};
...
export const SinglePayment: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: "New loan with only first payment made - shows beginning of payment history.",
      },
    },
  },
};
...
export const HighValuePayments: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: "Payment history for high-value property with larger payment amounts reflecting luxury real estate financing.",
      },
    },
  },
};
...
export const RecentPayments: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: "Recent payment history showing last 6 months of payment activity.",
      },
    },
  },
};
...
export const LongHistory: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: "Extended payment history showing 3 years of payment patterns and trends. Automatically paginated with 5 items per page.",
      },
    },
  },
};
...
export const LongHistoryCustomPagination: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: "Large payment history with custom pagination showing 10 items per page. Demonstrates pagination controls with many pages.",
      },
    },
  },
};
...
export const PaginationEdgeCase: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: "Payment history with exactly 6 payments (requires 2 pages with 5 items per page). Tests pagination with minimal pages.",
      },
    },
  },
};
...
export const WithPendingPayments: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: "Payment history with recent pending payments - shows current payment processing status.",
      },
    },
  },
};
...
export const DifferentPaymentTypes: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: "Payment history showing clear distribution of principal, interest, and escrow payments.",
      },
    },
  },
};