...
const meta: Meta<typeof FinancialMetrics> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: "Comprehensive financial metrics display showing purchase price, current value, monthly payments, interest rates, and returns. Perfect for investment property analysis.",
      },
    },
  },
  decorators: [
...
export const Default: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: "Standard financial metrics showing healthy investment with positive appreciation.",
      },
    },
  },
};
...
export const HighValueProperty: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: "Luxury property with high-value numbers showing multi-million dollar investment.",
      },
    },
  },
};
...
export const InvestmentMetrics: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: "Investment-focused property metrics showing strong returns and manageable payments.",
      },
    },
  },
};
...
export const LossScenario: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: "Property showing value decline - illustrates investment risk scenario.",
      },
    },
  },
};
...
export const LowInterestRate: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: "Property with favorable low interest rate showing lower monthly payments.",
      },
    },
  },
};
...
export const ShortTermLoan: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: "Property with short-term loan showing higher payments but faster equity buildup.",
      },
    },
  },
};
...
export const BreakEvenScenario: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: "Property at break-even point with no appreciation or depreciation.",
      },
    },
  },
};
...
export const FirstTimeHomeBuyer: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: "Affordable starter home perfect for first-time home buyers with manageable payments.",
      },
    },
  },
};
...
export const ComparisonView: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: "Side-by-side comparison of different investment strategies showing risk vs return profiles.",
      },
    },
  },
};