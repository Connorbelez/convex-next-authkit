...
const sampleMessages = [
  { id: 1, sender: "John Doe", message: "Hey, how are you?", time: "10:30 AM", avatar: "JD" },
  { id: 2, sender: "Jane Smith", message: "Meeting at 3 PM today", time: "11:45 AM", avatar: "JS" },
  { id: 3, sender: "Mike Johnson", message: "Can you review the document?", time: "Yesterday", avatar: "MJ" },
  { id: 4, sender: "Sarah Williams", message: "Thanks for your help!", time: "Yesterday", avatar: "SW" },
  { id: 5, sender: "Tom Brown", message: "Project update attached", time: "2 days ago", avatar: "TB" },
]

const sampleMedia = [
  { id: 1, type: "image", name: "Screenshot 2024.png", size: "2.4 MB", date: "Today" },
  { id: 2, type: "image", name: "Photo_001.jpg", size: "1.8 MB", date: "Yesterday" },
  { id: 3, type: "video", name: "Meeting_Recording.mp4", size: "45.2 MB", date: "Yesterday" },
  { id: 4, type: "image", name: "Design_Mockup.png", size: "3.1 MB", date: "2 days ago" },
  { id: 5, type: "image", name: "Profile_Picture.jpg", size: "890 KB", date: "3 days ago" },
]

const sampleLinks = [
  { id: 1, url: "https://github.com/project", title: "GitHub Repository", date: "Today" },
  { id: 2, url: "https://docs.example.com", title: "Documentation", date: "Yesterday" },
  { id: 3, url: "https://figma.com/design", title: "Figma Design File", date: "2 days ago" },
  { id: 4, url: "https://notion.so/notes", title: "Meeting Notes", date: "3 days ago" },
]
      ...
      <Drawer open={open} onOpenChange={setOpen}>
        ...
        <DrawerContent className="h-[85vh] flex flex-col z-200">
          <DrawerHeader className="border-b">
            ...
            <DrawerDescription className="sr-only">View and manage your settings</DrawerDescription>
